  ...
  const createTrainer = async () => {
    ...
    try {
      await api.post("/admin/trainers", {
        ...
        image_url: `https://placehold.co/150x150?text=${
          full_name.split(" ")[0]
        }`,
        rating: 5.0,
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full">
                <thead className="bg-gray-200 border-b-2 border-black">
                  <tr>
                    <th className="p-3 text-left text-sm font-extrabold text-black uppercase">
                      Name
                    </th>
                    <th className="p-3 text-left text-sm font-extrabold text-black uppercase hidden md:table-cell">
                      Email
                    </th>
                    <th className="p-3 text-left text-sm font-extrabold text-black uppercase hidden lg:table-cell">
                      Phone
                    </th>
                    <th className="p-3 text-left text-sm font-extrabold text-black uppercase">
                      Specialization
                    ...
                    <th className="p-3 text-center text-sm font-extrabold text-black uppercase">
                      Actions
                    </th>
                  </tr>
                </thead>
                  ...
                  {filteredTrainers.length > 0 ? (
                    filteredTrainers.map((trainer) => (
                      ...
                      >
                        ...
                        <td className="p-3 text-sm text-gray-700 hidden lg:table-cell">
                          {trainer.phone || "N/A"}
                        </td>
                        <td className="p-3">
                          <span
                            ...
                            >
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  ...
                                  {trainer.full_name}**? This action cannot be
                                  undone.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter className="pt-4 border-t-2 border-black">
                    ...
                    <tr>
                      <td
                        colSpan="6"
                        className="text-center py-6 text-gray-500 font-medium border-t"
                      >
